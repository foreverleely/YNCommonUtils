...
#import "YNCAlignCellFlowLayout.h"

#define widthOffset 20.f

@interface YNCAlignCellFlowLayout () {
...
@implementation YNCAlignCellFlowLayout

- (instancetype)init {
    return [self initWithType:YNCAlignWithCenter betweenOfCell:5.0];
}
